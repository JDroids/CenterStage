...
@Autonomous
public class CenterStageAutoRedLanderF6 extends LinearOpMode {
    private ElapsedTime runtime = new ElapsedTime();


    public static double leg1 = 200.00;   //Strafe 280
    public static double leg2 = 800.00;  //Go forward 800.00
    public static double leg3 = 0.00;  //Rotate counter clockwise 350.00
    public static double leg4 = 0.00;   //Go forward 0, 375, 650.00
    public static double leg5 = 0.00;   //Rotate clockwise 350.00
    public static double leg6 = 400.00;   //Go forward 350.00, 425.00, 550.00
