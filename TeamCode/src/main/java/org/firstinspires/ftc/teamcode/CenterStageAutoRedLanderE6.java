...
@Autonomous
public class CenterStageAutoRedLanderE6 extends LinearOpMode {
    private ElapsedTime runtime = new ElapsedTime();


    public static double leg1 = 200.00;   //Strafe 280
    public static double leg2 = 800.00;  //Go forward 800.00
    public static double leg3 = 350.00;  //Rotate counter clockwise 350.00
    public static double leg4 = 375.00;   //Go forward 0, 375, 650.00
    public static double leg5 = 350.00;   //Rotate clockwise 350.00
    public static double leg6 = 400.00;   //Go forward 550.00, 400.00, 550.00
    public static double leg7 = 100.00;   //Go backward 100.00
    ...
    public void runOpMode() {
        ...
        // Step 3:  Rotate 90 degree counter clockwise
        runtime.reset();
        ...
        // Step 5:  Rotate 90 degree clockwise
        runtime.reset();
