...
@Config
@Autonomous
public class CenterStageAutoBlueStageA6 extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        switch (centerStageVisionProcessor.getSelection()) {
            ...
            case MIDDLE:
                ...
                wrist.downWrist();
                drive.moveForward(inchesToTicks(1));
                claw.openClaw();
                runtime.reset();
                while (opModeIsActive() && (runtime.milliseconds() < clawPause)) {  }
                wrist.liftWrist();
                ...
                drive.moveBackward(inchesToTicks(INCHES_TO_SPIKE - INCHES_OFFSET-2));
                drive.moveCounterClockwise(inchesToTicks(INCHES_TO_NINETY_DEGREE));
                break;
            case RIGHT:
                //drive.moveForward(inchesToTicks(3));
                ...
                drive.moveClockwise(inchesToTicks(INCHES_TO_NINETY_DEGREE));
                drive.moveBackward(inchesToTicks(5 ));
                wrist.downWrist();
                drive.moveForward(inchesToTicks(4 ));
                claw.openClaw();
                //runtime.reset();
                //while (opModeIsActive() && (runtime.milliseconds() < clawPause)) {  }
                drive.moveBackward(inchesToTicks(2 ));
    ...
    private void depositRandomizedPixel(){
        wrist.downWrist();
        drive.moveForward(inchesToTicks(INCHES_OFFSET -4));
        claw.openClaw();
        runtime.reset();
        while (opModeIsActive() && (runtime.milliseconds() < clawPause)) {  }
        wrist.liftWrist();
