...
@Config
@Autonomous
public class CenterStageAutoRedStageE6 extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        drive.moveForward(inchesToTicks(26));
        ...
        switch (centerStageVisionProcessor.getSelection()) {
            case LEFT:
                ...
                drive.moveBackward(inchesToTicks(41));
                break;
            case MIDDLE:
                drive.moveForward(inchesToTicks(5));
                depositRandomizedPixel();
                ...
                drive.moveForward(inchesToTicks(36));
                break;
            case RIGHT:
                drive.moveClockwise(inchesToTicks(INCHES_TO_NINETY_DEGREE));
                drive.moveForward(inchesToTicks(5));
                depositRandomizedPixel();
                drive.moveForward(inchesToTicks(31));
                break;
            case NONE:
                drive.moveForward(inchesToTicks(5));
                depositRandomizedPixel();
