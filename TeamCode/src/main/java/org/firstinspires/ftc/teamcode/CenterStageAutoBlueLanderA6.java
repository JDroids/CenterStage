...
public class CenterStageAutoBlueLanderA6 extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        drive.moveForward(inchesToTicks(INCHES_TO_SPIKE-3));
        ...
        switch (centerStageVisionProcessor.getSelection()) {
            case LEFT:
                ...
                claw.closeClaw();
                drive.moveCounterClockwise(inchesToTicks(INCHES_TO_NINETY_DEGREE));
                drive.moveForward(inchesToTicks(INCHES_TO_SPIKE - INCHES_OFFSET-1));
            ...
            case MIDDLE:
                ...
                wrist.liftWrist();
                claw.closeClaw();
                drive.moveBackward(inchesToTicks(INCHES_TO_SPIKE - INCHES_OFFSET-3));
                drive.moveCounterClockwise(inchesToTicks(INCHES_TO_NINETY_DEGREE));
                break;
            case RIGHT:
                drive.moveClockwise(inchesToTicks(INCHES_TO_NINETY_DEGREE));
