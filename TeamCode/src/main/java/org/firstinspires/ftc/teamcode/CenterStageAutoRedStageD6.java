...
@Config
@Autonomous
public class CenterStageAutoRedStageD6 extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        switch (centerStageVisionProcessor.getSelection()) {
            case LEFT:
                ...
                drive.moveForward(inchesToTicks(INCHES_TO_NEXT_TILE-4));
                drive.moveClockwise(inchesToTicks(INCHES_TO_NINETY_DEGREE - 1));
                drive.moveForward(inchesToTicks(INCHES_TO_STAGE+2));
                break;
            case MIDDLE:
            ...
            case RIGHT:
                ...
                drive.moveClockwise(inchesToTicks(INCHES_TO_NINETY_DEGREE -1));
                drive.moveForward(inchesToTicks(INCHES_TO_STAGE -1));
                break;
            case NONE:
                drive.moveClockwise(inchesToTicks(INCHES_TO_ONEEIGHTY_DEGREE));
                wrist.downWrist();
