...
@Autonomous
public class CenterStageAutoRedStage extends LinearOpMode {

    private ElapsedTime runtime = new ElapsedTime();


    public static double leg1 = 660.00;   //125.00, 375.00, 650.00
    public static double leg2 = 350.00;  //330.00, 325.00
